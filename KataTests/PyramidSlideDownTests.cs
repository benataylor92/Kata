...
namespace KataTests
{
    ...
    public class PyramidSlideDownTests
    {
        ...
        public void SmallPyramidTest()
        {
            ...
            Assert.AreEqual(23, Kata.Kata__4_.PyramidSlideDown.LongestSlideDown(smallPyramid));
        }
        ...
        public void MediumPyramidTest()
        {
            ...
            Assert.AreEqual(1074, Kata.Kata__4_.PyramidSlideDown.LongestSlideDown((mediumPyramid)));
        }
    }
}
